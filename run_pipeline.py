...
def run_integration_test():
    ...
    # 1. Load Real/Synthetic 10-Feature Clinical Dataset
    ...
    # 2. Initialize and Train 10-Qubit VQC Model (Quick 2-Epoch Pass for Test)
    ...
    # (Extracting first layer weights for demonstration)
