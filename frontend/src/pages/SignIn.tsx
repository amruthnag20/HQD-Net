...
/**
 * Sign In — the entrance to the system.
 */
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        signIn()
        navigate('/app/home')
      }, 500) // slight pause to see the granted state
    }, 1200)
  }
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-sm text-secondary">
        Access your HQD-Net research workspace.
      </p>
      ...
      <form className="mt-8 flex flex-col gap-5" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="focus-ring font-mono text-[10px] tracking-widest text-muted transition-colors hover:text-secondary"
            >
              Forgot password?
            </button>
          </div>
      ...
      <div className="mt-8 flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          <span className="text-sm text-secondary">New to HQD-Net?</span>
          <Link
            to="/auth/sign-up"
          ...
          >
            Create Account <ArrowRight className="size-3" strokeWidth={2} />
          </Link>
        </div>
      </div>
